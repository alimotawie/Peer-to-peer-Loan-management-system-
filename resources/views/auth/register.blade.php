...
@section('content')
<div class="container col-md-10 col-md-offset-3 topmargin-lg">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                By clicking on Register, you agree to the <a href={{Route('terms')}}  target="_blank" >Terms and Conditions</a> of 3aNota.
                            </div>
                        </div>
