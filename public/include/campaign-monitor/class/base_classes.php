...
class CS_REST_Wrapper_Base {
     ...
     * of API loanrequest and response data
    ...
    /**
     * The default options to use for each API loanrequest.
     * These can be overridden by passing in an array as the call_options argument
     * to a single api loanrequest.
     * Valid options are:
     *
     * deserialise boolean:
    ...
    /**
     * Internal method to make a general API loanrequest based on the provided options
     * @param $call_options
     * @access private
     */
